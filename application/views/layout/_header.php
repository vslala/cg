...
<html lang="en">
<head>
    <link rel="shortcut icon" type="image/png" href="<?= base_url(); ?>images/static/logo.png"/>
...
<?php if(isset($thread[0])): ?>
  <meta property="og:url"                content="<?= $thread[0]['thread_url']; ?>" />
  <meta property="og:type"               content="article" />
  <meta property="og:title"              content="<?= $thread[0]['title']; ?>" />
  <meta property="og:description"        content="<?= $thread[0]['title']; ?>... Click to view the whole thread." />
  <meta property="og:image"              content="<?= $thread[0]['image_url']; ?>" />
<?php endif; ?>
